...
function highlighted(toBeHighlighted) {
    if(document.getElementById(toBeHighlighted + "ToolBarTitle").ariaLabel === "opened") {
        document.getElementById(toBeHighlighted + "IconSvg").style.stroke = "#fff";
        document.getElementById(toBeHighlighted + "ToolBarTitle").style.color = "#fff";
        document.getElementById(toBeHighlighted + "ToolBarTitle").ariaLabel = "closed";
    }

    else {
        document.getElementById(toBeHighlighted + "IconSvg").style.stroke = "#e39685";
        document.getElementById(toBeHighlighted + "ToolBarTitle").style.color = "#e39685";
        document.getElementById(toBeHighlighted + "ToolBarTitle").ariaLabel = "opened"
    }
}
