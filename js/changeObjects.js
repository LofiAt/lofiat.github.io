...
function changeThisIcon() {
    if(document.getElementById("sideBarTabOpened").style.display === "block") {
        document.getElementById("darkuxButton").style.marginLeft = "8px";
        document.getElementById("sideBarTabClosed").style.display = "block";
        document.getElementById("sideBarTabOpened").style.display = "none";
    }

    else {
        document.getElementById("darkuxButton").style.marginLeft = "316px";
        document.getElementById("sideBarTabClosed").style.display = "none";
        document.getElementById("sideBarTabOpened").style.display = "block";
    }
}
...
function moveImportantDarkUxInformation() {
    if (document.getElementById("spacesContent").style.display === "block"){
        document.getElementById("importantDarkUxInformation").style.marginLeft = "308px";
    }

    else if (document.getElementById("spacesContent").style.display === "none"){
        document.getElementById("importantDarkUxInformation").style.marginLeft = "0px";
    }
}

function moveTitleIcon() {
    if (document.getElementById("spacesContent").style.display === "block"){
        document.getElementById("darkuxButton").style.marginLeft = "8px";
    }
