...
var celebrity = [
  ['Study with StudyMD','MrkPc_mFQWU?rel=0&autoplay=1&modestbranding=1&autohide=1&showinfo=0&controls=0&showsearch=0&iv_load_policy=3&enablejsapi=1&disablekb=0&loop=1&playlist=MrkPc_mFQWU&mute=1','@StudyMD'],
  ['Study with KharmaMedic','fJP7c8xt1n4?rel=0&autoplay=1&modestbranding=1&autohide=1&showinfo=0&controls=0&showsearch=0&iv_load_policy=3&enablejsapi=1&disablekb=0&loop=1&playlist=fJP7c8xt1n4&mute=1','@StudyMD'],
  ['Study with Sebastian','CPIi6JEUufU?rel=0&autoplay=1&modestbranding=1&autohide=1&showinfo=0&controls=0&showsearch=0&iv_load_policy=3&enablejsapi=1&disablekb=0&loop=1&playlist=CPIi6JEUufU&mute=1','@StudyMD'],
  ['Study with Abao','grBFMP3HDZA?rel=0&autoplay=1&modestbranding=1&autohide=1&showinfo=0&controls=0&showsearch=0&iv_load_policy=3&enablejsapi=1&disablekb=0&loop=1&playlist=grBFMP3HDZA&mute=1','@StudyMD']
];
...
var snow = [
  ...
  ['Heavy Snow in Forest','embed/eS2ssUROF5o','@Cat Ambience']
];
...
function getVideoInformation(arrayName) {
  ...
  document.getElementById("spaceVideo").src = "https://www.youtube.com/embed/" + arrayName[i][1] + "?rel=0&autoplay=1&modestbranding=1&autohide=1&showinfo=0&controls=0&showsearch=0&iv_load_policy=3&enablejsapi=1&disablekb=0&mute=1&loop=1&playlist=" + arrayName[i][1];
